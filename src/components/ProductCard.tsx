  ...
  return (
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <div className={`absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-300 flex items-center justify-center space-x-3 ${isHovered ? 'opacity-100' : 'opacity-0'}`}>
          <button
          ...
          <button
            ...
            className={`p-2 rounded-full transition-all duration-300 transform hover:scale-110 ${
              isLiked ? 'bg-african-red text-white' : 'bg-white text-african-red hover:bg-african-red hover:text-white'
            }`}
          >
